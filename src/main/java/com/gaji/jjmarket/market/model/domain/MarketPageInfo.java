...
public class MarketPageInfo {
	...
	private int start; // 쿼리에 쓸것
	private int end; // 쿼리에 쓸것
	private int cntPage = 5; // 페이지바?
	
	public MarketPageInfo() {
	}
	public MarketPageInfo(int total, int nowPage, int cntPerPage) {
		setNowPage(nowPage);
